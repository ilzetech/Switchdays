...
public class SwitchDays {
	...
	public static void main(String[] args) {
        ...
        // we know that Java is case sensitive, therefore let's convert the word provided by the user to 
//		lower case so that the program works independent of the way the user writes the word e.g. Monday, monDAY, MoNdAy
		  // toLowerCase() is a method declared in the class String. The method converts 
//			all the characters in a given string to lower case
		  day = day.toLowerCase();
		 
      
        //switch () {
//note: a switch statement accepts a constant expression/variable of type String 
//		only starting with Java version 7; in earlier versions the compiler shows an "incompatible types" error.
            //case "monday":
